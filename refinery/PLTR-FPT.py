...
class TriadRiskEngine:
    ...
    def build_markov_core(self):
        print(f"[LAYER 1] Building Markov Core...")
    ...
    def apply_vix_filter(self):
        print(f"[LAYER 2] VIX Filter (Macro Sensor)...")
    ...
    def run_anomaly_detection(self):
        print(f"[LAYER 3] Anomaly Engine (Isolation Forest)...")
        ...
        if self.is_anomaly:
            print(f"    ALERT: Current behavior is ANOMALOUS!")
    ...
    def run_garch_forecast(self):
        print(f"[OPTIONAL] GARCH Volatility Forecast...")
    ...
    def run_full_analysis(self):
        ...
        if SKLEARN_AVAILABLE:
            ...
            print(f"    Status:       DISABLED (install sklearn)")
    ...
    def _plot_triad(self, paths, prob_up, prob_down, times_up, times_down):
        ...
        ax2.set_title(f"Time to UPSIDE Target", fontsize=11)
        ax2.set_xlabel("Days")
        ...
        ax3.set_title(f"Time to DOWNSIDE Target", fontsize=11)
        ax3.set_xlabel("Days")
